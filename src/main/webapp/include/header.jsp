<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    	...
    	<!-- 여기저기 공용으로 쓰일 부분(header 페이지)은 상대 경로 말고 절대 경로로 적기 -->
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <c:otherwise>
	                    ...
	                    <li>
	                        <a href="${pageContext.request.contextPath }/user/mypage.user" style="color:red">MY PAGE</a>
	                    </li>
                    </c:otherwise>
                    </c:choose>
